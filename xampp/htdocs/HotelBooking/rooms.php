...
<html lang="en">
	...
	<body class="bg-light">
		...
		<div class="my-5 px-4">
			<h2 class="fw-bold h-font text-center">OUR ROOM'S</h2>
		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-lg-3 col-md-12 mb-lg-0 mb-4 ps-4">
					<nav class="navbar navbar-expand-lg navbar-light bg-white rounded shadow bg-body-tertiary">
								...
								<div class="card mb-4 border-0 shadow">
									<div class="row g-0 p-3 align-items-center">
										...
										<div class="col-md-2 mt-lg-0 mt-md-0 mt-4 text-center">
											<h6 mb-4>₹$room_data[price] Per Night</h6>
											<a href="#" class="btn btn-sm w-100 text-white custom-bg shadow-none mb-2" id="custom-bg">Book Now</a>
